 ...
 * @date 2023/09/02
 */
public interface BoxDeliveryOrderService {
     ...
     * @return 整装箱出库订单列表
     */
    List<ExBoxDeliveryOrderDto> boxDeliveryOrderUndoList(Long collectionTaskId);
     ...
     * @return 整装箱出库订单列表
     */
    List<ExBoxDeliveryOrderDto> boxDeliveryOrderDeliveryList(List<Long> boxDeliveryOrderIdList);
